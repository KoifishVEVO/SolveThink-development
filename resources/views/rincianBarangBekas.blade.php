...
<div class="table-container">
        <h2 class="fw-bold heading-text">ASSET BARANG BEKAS</h2>
        <p class=" heading-text">Tabel asset barang bekas adalah tabel yang berisikan informasi terkait barang bekas</p>
        
        <div class="card">
            <div class="card-header card-color text-white">
                <strong>Data Tabel Asset Barang Bekas</strong>
            </div>
            <div class="card-body">
